...
type PagedRows = { rows: FilterRows; page: number; pageSize: number; total: number; totalPages: number };
...
function PurchaseTable({ title, tableKey, rows, selected, itemDrafts, editingRows, project, busy, importingItems, selectable, onSelect, onChange, onOrder, onImportItems, onEdit, onSave, onReturn, state, onState, onPage, onPageSize }: { title: string; tableKey: "unpurchased" | "purchased"; rows: PagedRows; selected: string[]; itemDrafts: Record<string, Record<string, string>>; editingRows?: Record<string, boolean>; project: Project; busy: boolean; importingItems: boolean; selectable?: boolean; onSelect?: (ids: string[]) => void; onChange: (id: string, key: string, value: string) => void; onOrder?: () => void; onImportItems?: (file: File) => void; onEdit?: (id: string) => void; onSave?: (id: string) => void; onReturn?: (id: string) => void; state: TableState; onState: (patch: Partial<TableState>) => void; onPage: (page: number) => void; onPageSize: (pageSize: number) => void }) {
