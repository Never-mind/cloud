...
function StatusTag({ status }: { status: string }) {
  const colors: Record<string, string> = { 草稿: "bg-[#fff7e6] text-warning-deep", 已确认: "bg-success-soft text-success-strong", 已废止: "bg-danger-soft text-danger" };
