...
/**
 * 竖排列里的关键往来方筛选。
 * 供应商应付/客户应收/实收/开票这几列在表格里是多行堆叠展示，一个视觉列对应多个语义字段，
 * 三横杠只挂在金额字段上，所以按往来方筛不到。这里把真正想筛的字段单独挂出来。
 */
const PARTY_FILTERS: Array<[string, string]> = [
  ["supplierPayablePayee", "供应商应付-供应商"],
  ["supplierPayablePayer", "供应商应付-承接单位"],
  ["customerReceivablePayer", "客户应收-客户"],
  ["customerReceivablePayee", "客户应收-承接单位"],
  ["collectionPayer", "客户实收-客户"],
  ["invoicePayer", "客户开票-客户"],
];
