        ...
        <StickyTable className="table-scroll overflow-auto" tableKey="internal-service-fee-available">
          <table className="w-full min-w-[1560px] border-collapse text-sm">
            <thead className="bg-[#f5f7fa] text-[#303133]">
              <tr>
                <th className="table-select-cell border-b border-r border-[#ebeef5] py-3 text-center font-medium [&>input]:h-3.5 [&>input]:w-3.5 [&>input]:align-middle"><input type="checkbox" checked={allSelected} onChange={toggleCurrentPageSelection} /></th>
            ...
            <tbody>
              {rows.map((row) => {
                ...
                return <tr className="hover:bg-[#fafafa]" key={id}>
                  <td className="table-select-cell border-b border-r border-[#ebeef5] py-3 text-center [&>input]:h-3.5 [&>input]:w-3.5 [&>input]:align-middle"><input type="checkbox" checked={selected.includes(id)} onChange={() => toggleRow(id)} /></td>
