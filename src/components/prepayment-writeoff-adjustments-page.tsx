  ...
  return (
    <div className="space-y-5">
      ...
      <Panel>
        ...
        <StickyTable className="table-scroll table-viewport overflow-auto" tableKey="prepayment-writeoff-adjustments">
