...
entityConfigs.push({
  ...
  detailRoute: "/product-catalog",
  description: "维护产品主档、品牌型号和后续按编码匹配的规格基础资料。",
  filters: [
    { key: "keyword", label: "产品主档", placeholder: "请输入主档编码、名称或品类" },
    { key: "status", label: "状态", type: "select", options: [{ label: "启用", value: "active" }, { label: "停用", value: "disabled" }] },
  ],
  listFields: [
    { key: "masterCode", label: "产品主档编码", sortable: true, filterable: true },
    { key: "name", label: "产品名称", sortable: true, filterable: true },
    { key: "nameEn", label: "英文名称", sortable: true, filterable: true },
  ...
  formFields: [
    { key: "id", label: "内部ID", hidden: true },
    { key: "masterCode", label: "产品主档编码", required: true },
...
entityConfigs.push(
  {
    ...
    primaryKey: "id",
    uniqueKeys: ["deviceType", "hsCode"],
    navGroup: "客户PO",
    route: "/tariff-rates",
    description: "维护产品类型与HS编码对应的税率及NOM要求。",
    filters: [{ key: "keyword", label: "税率", placeholder: "请输入设备类型或HS编码" }],
    listFields: [
      { key: "deviceType", label: "设备类型", sortable: true, filterable: true },
      { key: "hsCode", label: "HS编码", sortable: true, filterable: true },
      { key: "taxRate", label: "税率（%）", type: "percentage", sortable: true },
      { key: "needNom", label: "需要NOM", type: "boolean" },
      { key: "remark", label: "备注" },
    ],
    formFields: [
      { key: "id", label: "内部ID", hidden: true },
      { key: "deviceType", label: "设备类型", required: true },
      { key: "hsCode", label: "HS编码", required: true },
      { key: "taxRate", label: "税率（%）", type: "percentage", required: true },
      { key: "needNom", label: "需要NOM", type: "boolean" },
      { key: "remark", label: "备注", type: "textarea" },
    ],
    defaultSort: "deviceType ASC, hsCode ASC",
  },
  {
...
export const navGroups: NavGroup[] = [
  { title: "算力系统", items: [], children: powerChildren },
  {
    ...
    children: [
      ...
      { title: "采购管理", items: getEntitiesByKeys(["product-masters", "product-models", "product-specifications", "customer-product-aliases", "tariff-rates"]) },
    ],
  },
  {
    title: "华为云业务",
