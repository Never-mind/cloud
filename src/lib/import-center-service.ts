...
const EXECUTION_PLAN: Array<{
  ...
  },
  {
    ...
    table: "requestitems",
    primaryKey: "id",
    fields: ["id", "requestNo", "deviceCode", "supplierId", "requestedAt", "quantity"],
  },
  {
    key: "purchaseOrders",
  ...
  },
  {
    ...
    primaryKey: "id",
    fields: ["id", "purchaseOrderId", "poNo", "requestNo", "requestItemId", "unitPrice", "hardwareCoefficient", "softwareCoefficient", "totalCoefficient"],
  },
  {
