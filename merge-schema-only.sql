...
CREATE TABLE `merge_po_settlement_invoices` (
  ...
  `companyEntity` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '公司主体',
  `invoiceEntity` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '发票主体',
  `invoiceDate` date DEFAULT NULL COMMENT '发票日期',
  `invoiceNo` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '发票号',
